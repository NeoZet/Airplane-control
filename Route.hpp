...
/*! @class  Route
    ...
    перегруженные операторы ввода/вывод,а также методы,позволяющие рассчитать расстояние между начальным и конечным пунктом,рассчитать длину  ребра и построить ребро. 
*/
class Route {
private:
	//!Название маршрута
...
public:
	...
	*/
	...
	/*!
		Метод,позволяющий рассчитать расстояние между начальным и конечным пунктом
	*/
    void calcDistance();
	/*!
		Метод,позволяющий строить рёбра
	*/
